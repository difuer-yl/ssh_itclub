...
<title>基本设置 - ${session.SETTINGS.get('sitename')}</title>
</head>
<body>
			...
			<div class="tabCon">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="website-title" placeholder="控制在25个字、50个字节以内" value="${session.SETTINGS.get('sitename')}" class="input-text">
					</div>
				</div>
				<div class="row cl">
