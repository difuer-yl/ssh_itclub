...
<body>
	<div class="page-container">
		<form action="system_category_add_success" method="post"
			class="form form-horizontal" id="form-category-add">
				...
				<div class="">
					<div class="row cl">
						...
						<label class="form-label col-xs-4 col-sm-3"><span
							class="c-red">*</span>上级菜单：</label> <input hidden="hidden"
							name="parent_id" value="" />
						<div class="formControls col-xs-8 col-sm-9">
							<span class="select-box"> <select class="select"
								id="sel_Sub" name="parent_id" >
									<option value="0">顶级菜单</option>
									<s:if test="adminMenuList.size!=0">
										<s:iterator id="adminMenuList" value="category">
